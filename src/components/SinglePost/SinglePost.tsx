...
import ViewAllPostsBtn from "../ViewAllPostsBtn/ViewAllPostsBtn";
    ...
    <div className={styles.SinglePost}>
      ...
      <div className={styles.postBody}>
        ...
        <div className={styles.postDescription}>
          <p>Stand Blog is a free HTML CSS template for your CMS theme. You can easily adapt or customize it for any kind of CMS or website builder. You are allowed to use it for your business. You are NOT allowed to re-distribute the template ZIP file on any template collection site for the download purpose. Contact TemplateMo for more info. Thank you.</p>
        </div>
